...
<body>
    ...
    <div class="container-fluid bg-primary py-5 mb-5 page-header"
        style="background: url('{{ asset($header->gambar) }}') no-repeat center center; background-size: cover;">
    ...
    <div class="container-xxl py-2">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h1 class="mb-2">Contact For Any Query</h1>
            </div>
            <!-- Contact Start -->
            <div class="container-xxl py-2">
                <div class="container">
                            ...
                            <div class="text-center">
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-lg-3 col-md-6 text-center mb-4">
                                        <div class="card shadow-sm">
                                            <div class="ratio ratio-16x9">
                                                {{-- <iframe src="https://www.youtube.com/embed/your-video-id-1"
                                                    title="YouTube video" allowfullscreen></iframe> --}}
                                                <iframe width="560" height="315"
                                                    src="https://www.youtube.com/embed/_F3P-rE5d0E?si=psBC0XvHJ-UwLZUg"
                                    ...
                                    <div class="col-lg-3 col-md-6 text-center mb-4">
                                        <div class="card shadow-sm">
                                            <div class="ratio ratio-16x9">
                                                <iframe src="https://www.youtube.com/embed/your-video-id-3"
                                                    title="YouTube video" allowfullscreen></iframe>
                                            </div>
                                            <div class="card-body text-center">
                                    ...
                                    <div class="col-lg-3 col-md-6 text-center mb-4">
                                        <div class="card shadow-sm">
                                            <div class="ratio ratio-16x9">
                                                <iframe src="https://www.youtube.com/embed/your-video-id-4"
                                                    title="YouTube video" allowfullscreen></iframe>
                                            </div>
                                            <div class="card-body text-center">
