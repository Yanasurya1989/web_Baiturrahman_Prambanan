...
<head>
    ...
    <!-- Favicon -->
    <link href="{{ asset('rd-frontend/img/favicon.ico') }}" rel="icon">
    ...
    <link href="{{ asset('rd-frontend/lib/owlcarousel/assets/owl.carousel.min.css') }}" rel="stylesheet">
    <link href="{{ asset('rd-frontend/lib/tempusdominus/css/tempusdominus-bootstrap-4.min.css') }}" rel="stylesheet" />

    <!-- Customized Bootstrap Stylesheet -->
    <link href="{{ asset('rd-frontend/css/bootstrap.min.css') }}" rel="stylesheet">

    <!-- Template Stylesheet -->
    <link href="{{ asset('rd-frontend/css/style.css') }}" rel="stylesheet">
</head>
...
<body>
            ...
            <div class="carousel-inner">
                @foreach ($sliders as $index => $data)
                    <div class="carousel-item {{ $index == 0 ? 'active' : '' }}">
                        <img class="w-100" src="{{ asset($data->gambar) }}" alt="Image">
                        {{-- <img class="w-100" src="{{ asset('storage/' . $data->gambar) }}" alt="Image"> --}}

                        <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                            <div class="p-3" style="max-width: 900px;">
                                <h4 class="text-white text-uppercase mb-md-3">{{ $data->judul }}</h4>
                                <h1 class="display-1 text-white mb-md-4">{{ $data->deskripsi }}</h1>
                                <a href="" class="btn btn-primary py-md-3 px-md-5 mt-2">PPDB</a>
                            </div>
                        </div>
                    </div>
                @endforeach
        ...
        <div class="container pt-5 pb-3">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <img class="w-75 mb-4" src="{{ asset('rd-frontend/img/about.png') }}" alt="">
    ...
    <div class="container-fluid">
        <div class="container py-5">
            <h1 class="display-1 text-primary text-center">01</h1>
            <h1 class="display-4 text-uppercase text-center mb-5">Pengurus</h1>
            <div class="owl-carousel team-carousel position-relative" style="padding: 0 30px;">
                @foreach ($structurs as $data)
                    <div class="team-item">
                        {{-- <img class="img-fluid w-100" src="{{ asset('rd-frontend/img/team-1.jpg') }}" alt=""> --}}
                        <img class="img-fluid w-100" src="{{ $data->gambar }}" alt="">
                        <div class="position-relative py-4">
                            <h4 class="text-uppercase">{{ $data->nama }}</h4>
                            <p class="m-0">{{ $data->jabatan }}</p>
                            <div
                ...
                @endforeach
                {{-- <div class="team-item">
                    <img class="img-fluid w-100" src="{{ asset('rd-frontend/img/team-2.jpg') }}" alt="">
                    <div class="position-relative py-4">
                ...
                <div class="team-item">
                    <img class="img-fluid w-100" src="{{ asset('rd-frontend/img/team-3.jpg') }}" alt="">
                    <div class="position-relative py-4">
                        <h4 class="text-uppercase">Full Name</h4>
                        <p class="m-0">Designation</p>
                        <div
                ...
                <div class="team-item">
                    <img class="img-fluid w-100" src="{{ asset('rd-frontend/img/team-4.jpg') }}" alt="">
                    <div class="position-relative py-4">
                        <h4 class="text-uppercase">Full Name</h4>
                        <p class="m-0">Designation</p>
                        <div
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="rent-item mb-4">
                        <img class="img-fluid mb-4" src="{{ asset('rd-frontend/img/car-rent-1.png') }}"
                            alt="">
                ...
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="rent-item active mb-4">
                        <img class="img-fluid mb-4" src="{{ asset('rd-frontend/img/car-rent-2.png') }}"
                            alt="">
                        <h4 class="text-uppercase mb-4">Mercedes Benz R3</h4>
                        <div class="d-flex justify-content-center mb-4">
                            <div class="px-2">
                ...
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="rent-item mb-4">
                        <img class="img-fluid mb-4" src="{{ asset('rd-frontend/img/car-rent-3.png') }}"
                            alt="">
                        <h4 class="text-uppercase mb-4">Mercedes Benz R3</h4>
                        <div class="d-flex justify-content-center mb-4">
                            <div class="px-2">
                ...
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="rent-item mb-4">
                        <img class="img-fluid mb-4" src="{{ asset('rd-frontend/img/car-rent-4.png') }}"
                            alt="">
                        <h4 class="text-uppercase mb-4">Mercedes Benz R3</h4>
                        <div class="d-flex justify-content-center mb-4">
                            <div class="px-2">
                ...
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="rent-item mb-4">
                        <img class="img-fluid mb-4" src="{{ asset('rd-frontend/img/car-rent-5.png') }}"
                            alt="">
                        <h4 class="text-uppercase mb-4">Mercedes Benz R3</h4>
                        <div class="d-flex justify-content-center mb-4">
                            <div class="px-2">
                ...
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="rent-item mb-4">
                        <img class="img-fluid mb-4" src="{{ asset('rd-frontend/img/car-rent-6.png') }}"
                            alt="">
                        <h4 class="text-uppercase mb-4">Mercedes Benz R3</h4>
                        <div class="d-flex justify-content-center mb-4">
                            <div class="px-2">
                ...
                <div class="col-lg-6 px-0">
                    <div class="px-5 bg-secondary d-flex align-items-center justify-content-between"
                        ...
                        <img class="img-fluid flex-shrink-0 ml-n5 w-50 mr-4"
                            src="{{ asset('rd-frontend/img/banner-left.png') }}" alt="">
                ...
                <div class="col-lg-6 px-0">
                    <div class="px-5 bg-dark d-flex align-items-center justify-content-between"
                        ...
                        <img class="img-fluid flex-shrink-0 mr-n5 w-50 ml-4"
                            src="{{ asset('rd-frontend/img/banner-right.png') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container py-5">
            ...
            <div class="owl-carousel testimonial-carousel">
                <div class="testimonial-item d-flex flex-column justify-content-center px-4">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <img class="img-fluid ml-n4" src="{{ asset('rd-frontend/img/testimonial-1.jpg') }}"
                            alt="">
                ...
                <div class="testimonial-item d-flex flex-column justify-content-center px-4">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <img class="img-fluid ml-n4" src="{{ asset('rd-frontend/img/testimonial-2.jpg') }}"
                            alt="">
                        <h1 class="display-2 text-white m-0 fa fa-quote-right"></h1>
                    </div>
                    <h4 class="text-uppercase mb-2">Client Name</h4>
                ...
                <div class="testimonial-item d-flex flex-column justify-content-center px-4">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <img class="img-fluid ml-n4" src="{{ asset('rd-frontend/img/testimonial-3.jpg') }}"
                            alt="">
                        <h1 class="display-2 text-white m-0 fa fa-quote-right"></h1>
                    </div>
                    <h4 class="text-uppercase mb-2">Client Name</h4>
                ...
                <div class="testimonial-item d-flex flex-column justify-content-center px-4">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <img class="img-fluid ml-n4" src="{{ asset('rd-frontend/img/testimonial-4.jpg') }}"
                            alt="">
                        <h1 class="display-2 text-white m-0 fa fa-quote-right"></h1>
                    </div>
                    <h4 class="text-uppercase mb-2">Client Name</h4>
        ...
        <div class="container py-5">
            <div class="owl-carousel vendor-carousel">
                <div class="bg-light p-4">
                    <img src="{{ asset('rd-frontend/img/vendor-1.png') }}" alt="">
                </div>
                <div class="bg-light p-4">
                    <img src="{{ asset('rd-frontend/img/vendor-2.png') }}" alt="">
                </div>
                <div class="bg-light p-4">
                    <img src="{{ asset('rd-frontend/img/vendor-3.png') }}" alt="">
                </div>
                <div class="bg-light p-4">
                    <img src="{{ asset('rd-frontend/img/vendor-4.png') }}" alt="">
                </div>
                <div class="bg-light p-4">
                    <img src="{{ asset('rd-frontend/img/vendor-5.png') }}" alt="">
                </div>
                <div class="bg-light p-4">
                    <img src="{{ asset('rd-frontend/img/vendor-6.png') }}" alt="">
                </div>
                <div class="bg-light p-4">
                    <img src="{{ asset('rd-frontend/img/vendor-7.png') }}" alt="">
                </div>
                <div class="bg-light p-4">
                    <img src="{{ asset('rd-frontend/img/vendor-8.png') }}" alt="">
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="{{ asset('rd-frontend/lib/easing/easing.min.js') }}"></script>
    <script src="{{ asset('rd-frontend/lib/waypoints/waypoints.min.js') }}"></script>
    <script src="{{ asset('rd-frontend/lib/owlcarousel/owl.carousel.min.js') }}"></script>
    <script src="{{ asset('rd-frontend/lib/tempusdominus/js/moment.min.js') }}"></script>
    <script src="{{ asset('rd-frontend/lib/tempusdominus/js/moment-timezone.min.js') }}"></script>
    <script src="{{ asset('rd-frontend/lib/tempusdominus/js/tempusdominus-bootstrap-4.min.js') }}"></script>

    <!-- Template Javascript -->
    <script src="{{ asset('rd-frontend/js/main.js') }}"></script>
</body>
