...
<body>
        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-xl-7">
                    ...
                    <div class="tab-class p-4 white">
                        <ul class="nav navbar mb-2">
                            <li class="nav-item mb-3" id="about">
                                <a href="#" class="tab d-flex py-2 text-center bg-white" data-bs-toggle="pill">
                                    <span class="text-dark" style="width: 150px">Tentang</span>
                                </a>
                            </li>
                            <li class="nav-item mb-3" id="vission">
                                <a href="#" class="tab d-flex py-2 text-center bg-white" data-bs-toggle="pill">
                                    <span class="text-dark" style="width: 150px">Visi</span>
                                </a>
                            </li>
                            <li class="nav-item mb-3">
                                <a href="#mission" id="mission" class="tab d-flex py-2 text-center bg-white"
                                    data-bs-toggle="pill">
                                    <span class="text-dark" style="width: 150px">Misni</span>
                                </a>
                            </li>
                        </ul>
                        <div class="tab-content">
                                    ...
                                    <div class="col-12">
                                        <div class="d-flex">
                                            <div class="text-start my-auto">
                                                <h5 class="text-uppercase mb-3" id="aboutTitle">
                                                    Santunan Anak Yatim
                                                </h5>
                                                <p class="mb-3 white" id="aboutContent">
                            ...
                            <div id="about" class="tab-pane white p-0">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="d-flex">
                                            <div class="text-start my-auto">
                                                <h5 class="text-uppercase mb-3" id="vissionTitle">
                                                    Lorem, ipsum dolor.1
                                                </h5>
                                                <p class="mb-3" id="vissionContent">
                            ...
                            <div id="tab-3" class="tab-pane fade white p-0">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="d-flex">
                                            <div class="text-start my-auto">
                                                <h5 class="text-uppercase mb-3" id="missionTitle">
                                                    Lorem, ipsum dolor.3
                                                </h5>
                                                <p class="mb-3" id="missionContent">
                                                    Lorem ipsum dolor sit amet consectetur, adipisicing
                                                    elit. Odio optio ex consectetur. Aliquam, et!
                                                    Impedit!
                                                </p>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="section-thumbnail">
                            <a href=""><img src="{{ asset('frontend/assets/img/slider/ameng1.jfif') }}"
                                    alt="" /></a>
                            <div class="date">
                    ...
                    <div class="col-md-4">
                        <div class="section-thumbnail">
                            <a href=""><img src="{{ asset('frontend/assets/img/slider/ameng3.jpg') }}"
                                    alt="" /></a>
                            <div class="date">
                                <span class="number">12</span>
                                <span class="month">June, 2024</span>
    ...
    <script src="{{ asset('frontend/assets/js/js/about.js') }}"></script>
</body>
